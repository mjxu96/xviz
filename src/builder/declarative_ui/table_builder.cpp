...
XVIZTableBuilder::XVIZTableBuilder(const std::string& stream, bool display_object_id,
                   const std::string& title,
                   const std::string& description) : 
  XVIZBaseUIComponentBuilder("TABLE", title, description), stream_(stream), display_object_id_(display_object_id) {}
