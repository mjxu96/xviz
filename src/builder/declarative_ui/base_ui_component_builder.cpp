...
XVIZBaseUIComponentBuilder::XVIZBaseUIComponentBuilder(const std::string& type, const std::string& title,
    const std::string& description) : XVIZBaseUIBuilder(type), title_(title), description_(description) {}
