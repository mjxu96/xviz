...
XVIZPlotBuilder::XVIZPlotBuilder(const std::string& independent_variable,
                  const std::vector<std::string>& dependent_variables,
                  const std::string& title,
                  const std::string& description) :
  XVIZBaseUIComponentBuilder("PLOT", title, description), independent_variable_(independent_variable),
