...
#ifndef GOOGLE_PROTOBUF_INCLUDED_xviz_2fv2_2fstyle_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_xviz_2fv2_2fstyle_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_xviz_2fv2_2fstyle_2eproto
...
struct TableStruct_xviz_2fv2_2fstyle_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xviz_2fv2_2fstyle_2eproto;
namespace xviz {
namespace v2 {
class Color;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::xviz::v2::Color* Arena::CreateMaybeMessage<::xviz::v2::Color>(Arena*);
template<> ::xviz::v2::StyleClass* Arena::CreateMaybeMessage<::xviz::v2::StyleClass>(Arena*);
template<> ::xviz::v2::StyleObjectValue* Arena::CreateMaybeMessage<::xviz::v2::StyleObjectValue>(Arena*);
template<> ::xviz::v2::StyleStreamValue* Arena::CreateMaybeMessage<::xviz::v2::StyleStreamValue>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xviz {
namespace v2 {
...
class StyleClass :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xviz.v2.StyleClass) */ {
 public:
  StyleClass();
  virtual ~StyleClass();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_xviz_2fv2_2fstyle_2eproto);
    return ::descriptor_table_xviz_2fv2_2fstyle_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // .xviz.v2.StyleObjectValue style = 2;
 ...
 private:
  ...
  friend struct ::TableStruct_xviz_2fv2_2fstyle_2eproto;
};
// -------------------------------------------------------------------

class StyleObjectValue :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xviz.v2.StyleObjectValue) */ {
 public:
  StyleObjectValue();
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xviz.v2.StyleObjectValue";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // .xviz.v2.TextAnchor text_anchor = 7;
  void clear_text_anchor();
  ::xviz::v2::TextAnchor text_anchor() const;
  void set_text_anchor(::xviz::v2::TextAnchor value);
  private:
  ::xviz::v2::TextAnchor _internal_text_anchor() const;
  void _internal_set_text_anchor(::xviz::v2::TextAnchor value);
  public:

  // .xviz.v2.TextAlignmentBaseline text_baseline = 8;
  void clear_text_baseline();
  ::xviz::v2::TextAlignmentBaseline text_baseline() const;
  void set_text_baseline(::xviz::v2::TextAlignmentBaseline value);
  private:
  ::xviz::v2::TextAlignmentBaseline _internal_text_baseline() const;
  void _internal_set_text_baseline(::xviz::v2::TextAlignmentBaseline value);
  public:
...
class StyleStreamValue :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xviz.v2.StyleStreamValue) */ {
 public:
  StyleStreamValue();
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xviz.v2.StyleStreamValue";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // .xviz.v2.PointColorMode point_color_mode = 21;
  void clear_point_color_mode();
  ::xviz::v2::PointColorMode point_color_mode() const;
  void set_point_color_mode(::xviz::v2::PointColorMode value);
  private:
  ::xviz::v2::PointColorMode _internal_point_color_mode() const;
  void _internal_set_point_color_mode(::xviz::v2::PointColorMode value);
  public:
...
class Color :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xviz.v2.Color) */ {
 public:
  Color();
  virtual ~Color();
...
inline const std::string& StyleClass::name() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleClass.name)
  return _internal_name();
}
inline void StyleClass::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleClass.name)
}
inline std::string* StyleClass::mutable_name() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.StyleClass.name)
...
inline void StyleClass::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:xviz.v2.StyleClass.name)
}
inline void StyleClass::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:xviz.v2.StyleClass.name)
}
inline void StyleClass::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xviz.v2.StyleClass.name)
}
...
inline std::string* StyleClass::release_name() {
  // @@protoc_insertion_point(field_release:xviz.v2.StyleClass.name)
...
inline void StyleClass::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.StyleClass.name)
}
...
inline const ::xviz::v2::StyleObjectValue& StyleClass::_internal_style() const {
...
inline const ::xviz::v2::StyleObjectValue& StyleClass::style() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleClass.style)
  return _internal_style();
}
inline ::xviz::v2::StyleObjectValue* StyleClass::release_style() {
  // @@protoc_insertion_point(field_release:xviz.v2.StyleClass.style)
  
  ::xviz::v2::StyleObjectValue* temp = style_;
  style_ = nullptr;
  return temp;
}
inline ::xviz::v2::StyleObjectValue* StyleClass::_internal_mutable_style() {
...
inline ::xviz::v2::StyleObjectValue* StyleClass::mutable_style() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.StyleClass.style)
  return _internal_mutable_style();
}
inline void StyleClass::set_allocated_style(::xviz::v2::StyleObjectValue* style) {
  ...
  style_ = style;
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.StyleClass.style)
}
...
inline const std::string& StyleObjectValue::fill_color() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.fill_color)
...
inline void StyleObjectValue::set_fill_color(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.fill_color)
}
inline std::string* StyleObjectValue::mutable_fill_color() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.StyleObjectValue.fill_color)
...
inline void StyleObjectValue::set_fill_color(std::string&& value) {
  ...
  fill_color_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xviz.v2.StyleObjectValue.fill_color)
}
inline void StyleObjectValue::set_fill_color(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:xviz.v2.StyleObjectValue.fill_color)
}
inline void StyleObjectValue::set_fill_color(const void* value, size_t size) {
  ...
  fill_color_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xviz.v2.StyleObjectValue.fill_color)
}
...
inline std::string* StyleObjectValue::release_fill_color() {
  // @@protoc_insertion_point(field_release:xviz.v2.StyleObjectValue.fill_color)
...
inline void StyleObjectValue::set_allocated_fill_color(std::string* fill_color) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.StyleObjectValue.fill_color)
}
...
inline const std::string& StyleObjectValue::stroke_color() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.stroke_color)
...
inline void StyleObjectValue::set_stroke_color(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.stroke_color)
}
inline std::string* StyleObjectValue::mutable_stroke_color() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.StyleObjectValue.stroke_color)
...
inline void StyleObjectValue::set_stroke_color(std::string&& value) {
  ...
  stroke_color_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xviz.v2.StyleObjectValue.stroke_color)
}
inline void StyleObjectValue::set_stroke_color(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:xviz.v2.StyleObjectValue.stroke_color)
}
inline void StyleObjectValue::set_stroke_color(const void* value, size_t size) {
  ...
  stroke_color_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xviz.v2.StyleObjectValue.stroke_color)
}
...
inline std::string* StyleObjectValue::release_stroke_color() {
  // @@protoc_insertion_point(field_release:xviz.v2.StyleObjectValue.stroke_color)
...
inline void StyleObjectValue::set_allocated_stroke_color(std::string* stroke_color) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.StyleObjectValue.stroke_color)
}
...
inline float StyleObjectValue::stroke_width() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.stroke_width)
...
inline void StyleObjectValue::set_stroke_width(float value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.stroke_width)
}
...
inline float StyleObjectValue::radius() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.radius)
...
inline void StyleObjectValue::set_radius(float value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.radius)
}
...
inline float StyleObjectValue::text_size() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.text_size)
...
inline void StyleObjectValue::set_text_size(float value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.text_size)
}
...
inline float StyleObjectValue::text_rotation() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.text_rotation)
...
inline void StyleObjectValue::set_text_rotation(float value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.text_rotation)
}
...
inline ::xviz::v2::TextAnchor StyleObjectValue::_internal_text_anchor() const {
  return static_cast< ::xviz::v2::TextAnchor >(text_anchor_);
}
inline ::xviz::v2::TextAnchor StyleObjectValue::text_anchor() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.text_anchor)
  return _internal_text_anchor();
}
inline void StyleObjectValue::_internal_set_text_anchor(::xviz::v2::TextAnchor value) {
  
  text_anchor_ = value;
}
inline void StyleObjectValue::set_text_anchor(::xviz::v2::TextAnchor value) {
  _internal_set_text_anchor(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.text_anchor)
}
...
inline ::xviz::v2::TextAlignmentBaseline StyleObjectValue::_internal_text_baseline() const {
  return static_cast< ::xviz::v2::TextAlignmentBaseline >(text_baseline_);
}
inline ::xviz::v2::TextAlignmentBaseline StyleObjectValue::text_baseline() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.text_baseline)
  return _internal_text_baseline();
}
inline void StyleObjectValue::_internal_set_text_baseline(::xviz::v2::TextAlignmentBaseline value) {
  
  text_baseline_ = value;
}
inline void StyleObjectValue::set_text_baseline(::xviz::v2::TextAlignmentBaseline value) {
  _internal_set_text_baseline(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.text_baseline)
}
...
inline float StyleObjectValue::height() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleObjectValue.height)
...
inline void StyleObjectValue::set_height(float value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleObjectValue.height)
}
...
inline const std::string& StyleStreamValue::fill_color() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.fill_color)
  return _internal_fill_color();
}
inline void StyleStreamValue::set_fill_color(const std::string& value) {
  _internal_set_fill_color(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.fill_color)
}
inline std::string* StyleStreamValue::mutable_fill_color() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.StyleStreamValue.fill_color)
  return _internal_mutable_fill_color();
}
...
inline void StyleStreamValue::set_fill_color(std::string&& value) {
  ...
  fill_color_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xviz.v2.StyleStreamValue.fill_color)
}
inline void StyleStreamValue::set_fill_color(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  fill_color_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:xviz.v2.StyleStreamValue.fill_color)
}
inline void StyleStreamValue::set_fill_color(const void* value, size_t size) {
  
  fill_color_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xviz.v2.StyleStreamValue.fill_color)
}
...
inline std::string* StyleStreamValue::release_fill_color() {
  // @@protoc_insertion_point(field_release:xviz.v2.StyleStreamValue.fill_color)
...
inline void StyleStreamValue::set_allocated_fill_color(std::string* fill_color) {
  ...
  fill_color_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), fill_color);
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.StyleStreamValue.fill_color)
}
...
inline const std::string& StyleStreamValue::stroke_color() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.stroke_color)
  return _internal_stroke_color();
}
inline void StyleStreamValue::set_stroke_color(const std::string& value) {
  _internal_set_stroke_color(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.stroke_color)
}
inline std::string* StyleStreamValue::mutable_stroke_color() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.StyleStreamValue.stroke_color)
  return _internal_mutable_stroke_color();
}
...
inline void StyleStreamValue::set_stroke_color(std::string&& value) {
  ...
  stroke_color_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xviz.v2.StyleStreamValue.stroke_color)
}
inline void StyleStreamValue::set_stroke_color(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  stroke_color_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:xviz.v2.StyleStreamValue.stroke_color)
}
inline void StyleStreamValue::set_stroke_color(const void* value, size_t size) {
  
  stroke_color_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xviz.v2.StyleStreamValue.stroke_color)
}
...
inline std::string* StyleStreamValue::release_stroke_color() {
  // @@protoc_insertion_point(field_release:xviz.v2.StyleStreamValue.stroke_color)
...
inline void StyleStreamValue::set_allocated_stroke_color(std::string* stroke_color) {
  ...
  stroke_color_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), stroke_color);
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.StyleStreamValue.stroke_color)
}
...
inline float StyleStreamValue::stroke_width() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.stroke_width)
  return _internal_stroke_width();
}
...
inline void StyleStreamValue::set_stroke_width(float value) {
  _internal_set_stroke_width(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.stroke_width)
}
...
inline float StyleStreamValue::radius() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.radius)
  return _internal_radius();
}
...
inline void StyleStreamValue::set_radius(float value) {
  _internal_set_radius(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.radius)
}
...
inline float StyleStreamValue::text_size() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.text_size)
  return _internal_text_size();
}
...
inline void StyleStreamValue::set_text_size(float value) {
  _internal_set_text_size(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.text_size)
}
...
inline float StyleStreamValue::text_rotation() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.text_rotation)
  return _internal_text_rotation();
}
...
inline void StyleStreamValue::set_text_rotation(float value) {
  _internal_set_text_rotation(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.text_rotation)
}
...
inline ::xviz::v2::TextAnchor StyleStreamValue::_internal_text_anchor() const {
  return static_cast< ::xviz::v2::TextAnchor >(text_anchor_);
}
inline ::xviz::v2::TextAnchor StyleStreamValue::text_anchor() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.text_anchor)
  return _internal_text_anchor();
}
inline void StyleStreamValue::_internal_set_text_anchor(::xviz::v2::TextAnchor value) {
  
  text_anchor_ = value;
}
inline void StyleStreamValue::set_text_anchor(::xviz::v2::TextAnchor value) {
  _internal_set_text_anchor(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.text_anchor)
}
...
inline ::xviz::v2::TextAlignmentBaseline StyleStreamValue::_internal_text_baseline() const {
  return static_cast< ::xviz::v2::TextAlignmentBaseline >(text_baseline_);
}
inline ::xviz::v2::TextAlignmentBaseline StyleStreamValue::text_baseline() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.text_baseline)
  return _internal_text_baseline();
}
inline void StyleStreamValue::_internal_set_text_baseline(::xviz::v2::TextAlignmentBaseline value) {
  
  text_baseline_ = value;
}
inline void StyleStreamValue::set_text_baseline(::xviz::v2::TextAlignmentBaseline value) {
  _internal_set_text_baseline(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.text_baseline)
}
...
inline float StyleStreamValue::height() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.height)
  return _internal_height();
}
...
inline void StyleStreamValue::set_height(float value) {
  _internal_set_height(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.height)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 StyleStreamValue::radius_min_pixels() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.radius_min_pixels)
...
inline void StyleStreamValue::set_radius_min_pixels(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.radius_min_pixels)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 StyleStreamValue::radius_max_pixels() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.radius_max_pixels)
...
inline void StyleStreamValue::set_radius_max_pixels(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.radius_max_pixels)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 StyleStreamValue::stroke_width_min_pixels() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.stroke_width_min_pixels)
...
inline void StyleStreamValue::set_stroke_width_min_pixels(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.stroke_width_min_pixels)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 StyleStreamValue::stroke_width_max_pixels() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.stroke_width_max_pixels)
...
inline void StyleStreamValue::set_stroke_width_max_pixels(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.stroke_width_max_pixels)
}
...
inline float StyleStreamValue::opacity() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.opacity)
...
inline void StyleStreamValue::set_opacity(float value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.opacity)
}
...
inline bool StyleStreamValue::stroked() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.stroked)
...
inline void StyleStreamValue::set_stroked(bool value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.stroked)
}
...
inline bool StyleStreamValue::filled() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.filled)
...
inline void StyleStreamValue::set_filled(bool value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.filled)
}
...
inline bool StyleStreamValue::extruded() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.extruded)
...
inline void StyleStreamValue::set_extruded(bool value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.extruded)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 StyleStreamValue::radius_pixels() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.radius_pixels)
...
inline void StyleStreamValue::set_radius_pixels(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.radius_pixels)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 StyleStreamValue::font_weight() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.font_weight)
...
inline void StyleStreamValue::set_font_weight(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.font_weight)
}
...
inline const std::string& StyleStreamValue::font_family() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.font_family)
...
inline void StyleStreamValue::set_font_family(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.font_family)
}
inline std::string* StyleStreamValue::mutable_font_family() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.StyleStreamValue.font_family)
...
inline void StyleStreamValue::set_font_family(std::string&& value) {
  ...
  font_family_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xviz.v2.StyleStreamValue.font_family)
}
inline void StyleStreamValue::set_font_family(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:xviz.v2.StyleStreamValue.font_family)
}
inline void StyleStreamValue::set_font_family(const char* value, size_t size) {
  ...
  font_family_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xviz.v2.StyleStreamValue.font_family)
}
...
inline std::string* StyleStreamValue::release_font_family() {
  // @@protoc_insertion_point(field_release:xviz.v2.StyleStreamValue.font_family)
...
inline void StyleStreamValue::set_allocated_font_family(std::string* font_family) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.StyleStreamValue.font_family)
}
...
inline ::xviz::v2::PointColorMode StyleStreamValue::_internal_point_color_mode() const {
  return static_cast< ::xviz::v2::PointColorMode >(point_color_mode_);
}
inline ::xviz::v2::PointColorMode StyleStreamValue::point_color_mode() const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.point_color_mode)
  return _internal_point_color_mode();
}
inline void StyleStreamValue::_internal_set_point_color_mode(::xviz::v2::PointColorMode value) {
  
  point_color_mode_ = value;
}
inline void StyleStreamValue::set_point_color_mode(::xviz::v2::PointColorMode value) {
  _internal_set_point_color_mode(value);
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.point_color_mode)
}
...
inline float StyleStreamValue::point_color_domain(int index) const {
  // @@protoc_insertion_point(field_get:xviz.v2.StyleStreamValue.point_color_domain)
...
inline void StyleStreamValue::set_point_color_domain(int index, float value) {
  ...
  // @@protoc_insertion_point(field_set:xviz.v2.StyleStreamValue.point_color_domain)
}
...
inline void StyleStreamValue::add_point_color_domain(float value) {
  ...
  // @@protoc_insertion_point(field_add:xviz.v2.StyleStreamValue.point_color_domain)
}
...
StyleStreamValue::point_color_domain() const {
  // @@protoc_insertion_point(field_list:xviz.v2.StyleStreamValue.point_color_domain)
...
StyleStreamValue::mutable_point_color_domain() {
  // @@protoc_insertion_point(field_mutable_list:xviz.v2.StyleStreamValue.point_color_domain)
...
inline const std::string& Color::values() const {
  // @@protoc_insertion_point(field_get:xviz.v2.Color.values)
  return _internal_values();
}
inline void Color::set_values(const std::string& value) {
  _internal_set_values(value);
  // @@protoc_insertion_point(field_set:xviz.v2.Color.values)
}
inline std::string* Color::mutable_values() {
  // @@protoc_insertion_point(field_mutable:xviz.v2.Color.values)
...
inline void Color::set_values(std::string&& value) {
  ...
  values_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xviz.v2.Color.values)
}
inline void Color::set_values(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:xviz.v2.Color.values)
}
inline void Color::set_values(const void* value, size_t size) {
  ...
  values_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xviz.v2.Color.values)
}
...
inline std::string* Color::release_values() {
  // @@protoc_insertion_point(field_release:xviz.v2.Color.values)
...
inline void Color::set_allocated_values(std::string* values) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xviz.v2.Color.values)
}
...
template <> struct is_proto_enum< ::xviz::v2::TextAnchor> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xviz::v2::TextAnchor>() {
  return ::xviz::v2::TextAnchor_descriptor();
}
template <> struct is_proto_enum< ::xviz::v2::TextAlignmentBaseline> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xviz::v2::TextAlignmentBaseline>() {
  return ::xviz::v2::TextAlignmentBaseline_descriptor();
}
template <> struct is_proto_enum< ::xviz::v2::PointColorMode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xviz::v2::PointColorMode>() {
  return ::xviz::v2::PointColorMode_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_xviz_2fv2_2fstyle_2eproto
