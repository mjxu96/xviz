...
class PrimitiveBase : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xviz.PrimitiveBase) */ {
 public:
  ...
  inline PrimitiveBase* New() const { return New(NULL); }

  PrimitiveBase* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  static PrimitiveBase* default_instance_;
};
// -------------------------------------------------------------------
...
class Stadium : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xviz.Stadium) */ {
 public:
  ...
  inline Stadium* New() const { return New(NULL); }

  Stadium* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static Stadium* default_instance_;
};
// -------------------------------------------------------------------
...
inline void PrimitiveBase::clear_style() {
