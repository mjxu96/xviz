...
#ifndef PROTOBUF_style_2eproto__INCLUDED
#define PROTOBUF_style_2eproto__INCLUDED
...
class StyleClass : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xviz.StyleClass) */ {
 public:
  ...
  inline StyleClass* New() const { return New(NULL); }

  StyleClass* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  friend void  protobuf_AddDesc_style_2eproto();
  friend void protobuf_AssignDesc_style_2eproto();
  friend void protobuf_ShutdownFile_style_2eproto();

  void InitAsDefaultInstance();
  static StyleClass* default_instance_;
};
// -------------------------------------------------------------------
...
class StyleObjectValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xviz.StyleObjectValue) */ {
 public:
  ...
  inline StyleObjectValue* New() const { return New(NULL); }

  StyleObjectValue* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static StyleObjectValue* default_instance_;
};
// -------------------------------------------------------------------
...
class StyleStreamValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xviz.StyleStreamValue) */ {
 public:
  ...
  inline StyleStreamValue* New() const { return New(NULL); }

  StyleStreamValue* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static StyleStreamValue* default_instance_;
};
// -------------------------------------------------------------------
...
template <> struct is_proto_enum< ::xviz::TextAnchor> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xviz::TextAnchor>() {
  return ::xviz::TextAnchor_descriptor();
}
template <> struct is_proto_enum< ::xviz::TextAlignmentBaseline> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_style_2eproto__INCLUDED
